        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_account" value="{{ old('txt_account') }}">
                </div>
                <div class="form-group">
                    <label>Mật khẩu<span class="text-danger">*</span></label>
                    <input type="password" class="form-control" name="txt_password"  value="{{ old('txt_password') }}">
                </div>
                <div class="form-group">
        ...
        $("#myform").validate({
            ...
            rules: {
                ...
                txt_name: {
                    ...
                    // alphanumeric:"Tên không được chứa kí tự đặc biệt"
                },
                "txt_account": {
                    required: "Hãy nhập tên tài khoản*",
                    // alphanumeric: "Tài khoản không chứa kí tự đặc biết"
                },
                "txt_password": {
